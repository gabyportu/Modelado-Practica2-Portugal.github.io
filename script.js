...
selectButton.addEventListener('click', function() {
    ...
    switch (selectedMethod) {
        case 'cuadradosM':
            document.getElementById('cuadrados-form').style.display = 'block';
        ...
        case 'productosM':
            ...
            document.getElementById('productos-form').style.display = 'block';
            document.getElementById('lineal-form').style.display = 'none';
            document.getElementById('multiplicativo-form').style.display = 'none';
            break;
        case 'lineal':
            document.getElementById('cuadrados-form').style.display = 'none';
            document.getElementById('productos-form').style.display = 'none';
            document.getElementById('lineal-form').style.display = 'block';
            document.getElementById('multiplicativo-form').style.display = 'none';
            break;
        case 'multiplicativo':
            document.getElementById('cuadrados-form').style.display = 'none';
            document.getElementById('productos-form').style.display = 'none';
            document.getElementById('lineal-form').style.display = 'none';
            document.getElementById('multiplicativo-form').style.display = 'block';
            break;
        default:
            document.getElementById('cuadrados-form').style.display = 'none';
            document.getElementById('productos-form').style.display = 'none';
...
document.getElementById('multiplicativo-form').addEventListener('submit', function(event){
    ...
    const a = parseInt(document.getElementById('aM').value);
